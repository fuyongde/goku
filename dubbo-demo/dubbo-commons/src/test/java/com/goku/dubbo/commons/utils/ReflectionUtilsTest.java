...
public class ReflectionUtilsTest {
  ...
  public void testInvokeGetter() throws Exception {
    Object name = ReflectionUtils.invokeGetter(person, NAME_FIELD);
  ...
  public void testInvokeSetter() throws Exception {
    String name = "niki";
    ReflectionUtils.invokeSetter(person, NAME_FIELD, name);
  ...
  public void testGetFieldValue() throws Exception {
    Object name = ReflectionUtils.getFieldValue(person, NAME_FIELD);
    assertEquals(person.getName(), name);
  }
  ...
  public void testSetFieldValue() throws Exception {
    String name = "niki";
    ReflectionUtils.setFieldValue(person, NAME_FIELD, name);
    assertEquals(name, person.getName());
  }
  ...
  public void testInvokeMethod() throws Exception {
    Object name = ReflectionUtils.invokeMethod(person, GET_NAME_METHOD, null, null);
    assertEquals(person.getName(), name);

    String otherName = "niki";
    Class[] paramTypes = new Class[]{String.class};
    Object[] params = new Object[]{otherName};
    ReflectionUtils.invokeMethod(person, SET_NAME_METHOD, paramTypes, params);
  ...
  public void testInvokeMethodByName() throws Exception {
    String otherName = "niki";
    Object[] params = new Object[]{otherName};
    ReflectionUtils.invokeMethodByName(person, SET_NAME_METHOD, params);
    assertEquals(otherName, person.getName());
  }
